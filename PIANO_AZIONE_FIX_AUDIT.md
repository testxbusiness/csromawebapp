...
| P2.2 Ridurre componenti monolitici | **In corso** | Priorità ai tre `ChampionshipsManager` duplicati e alle dashboard atleta/coach. La refactor procederà per feature: tipi/mapping condivisi, hook di caricamento, mutazioni e componenti presentazionali separati. Ogni estrazione sarà verificata con TypeScript, lint, build e test manuali della relativa area. |
