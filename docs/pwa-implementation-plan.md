...
- [x] Testare l'upgrade da una sessione già installata: il banner “Aggiorna” attiva il worker in attesa e ricarica correttamente l'app, verificato su iPhone, Android e desktop.
