...
| G10.6 E2E matrice finale | [-] | G10.5 | Verifica Preview parziale il 03/09/2026: 26 test passati, 1 fallito e 1 saltato nella selezione staging; il fallimento ha evidenziato che l’area familiare non veniva mantenuta dopo navigazione completa verso `/athlete/messages`. Correzione applicata in `AccessibleProfileContext` con persistenza dell’area attiva e test dedicato; Jest 59 suite/195 test, typecheck, build e diff check superati. Il rerun E2E non è partito perché Chromium headless termina con `SIGTRAP`/`kill EPERM` in questo host. Restano da eseguire la matrice completa, lo smoke familiare dedicato sui viewport previsti, gli scenari PWA sul dispositivo e la chiusura del rilievo “Firma documenti”. |
