    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-5">
          ...
          <ChampionshipToolbar
            ...
            actions={(
              <>
                {mode !== 'athlete' && (
                  <Button size="icon" variant="outline" title="Aggiungi girone" aria-label="Aggiungi girone" onClick={() => setShowGroupModal(true)} disabled={!selectedChampionshipId || mode === 'coach'}>
      ...
      <div className="grid gap-4 md:grid-cols-2 mt-4">
        <ChampionshipInfoPanel
          description="Riepilogo sintetico dell’assetto selezionato."
        ...
        <NextMatchPanel
          ...
          helperText="Apri la convocazione e controlla la rosa pubblicata per la gara."
