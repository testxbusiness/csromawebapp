    ...
    <div className="space-y-6">
      <Card variant="primary" className="overflow-hidden">
        <div className="flex flex-col gap-5">
          ...
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] lg:items-end">
            ...
            {mode !== 'athlete' && (
              <Button variant="outline" className="min-h-11" onClick={() => setShowGroupModal(true)} disabled={!selectedChampionshipId || mode === 'coach'}>
      ...
      <div className="grid gap-4 md:grid-cols-2 mt-4">
        <Card>
          ...
          <CardMeta>Riepilogo sintetico dell’assetto selezionato.</CardMeta>
        ...
        <Card variant="primary" className="overflow-hidden">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <CardMeta>Collegamento rapido a convocazioni e controllo operativo della prossima gara.</CardMeta>
            </div>
