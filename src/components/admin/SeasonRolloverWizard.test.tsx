...
const sourceSeason = { id: '11111111-1111-4111-8111-111111111111', name: 'Stagione 2025/2026', start_date: '2025-09-01', end_date: '2026-06-30', is_active: true }
const targetSeason = { id: '22222222-2222-4222-8222-222222222222', name: 'Stagione 2026/2027', start_date: '2026-09-01', end_date: '2027-06-30', is_active: false }
...
const teamPreview = { teams: [{ source: { id: sourceTeamId, name: 'U16 Test', code: 'U16', activity_id: sourceTeamId, activity: { id: sourceTeamId, name: 'Basket Test', season_id: sourceSeason.id } }, mappedActivity: { id: targetTeamId, name: 'Basket Test', season_id: targetSeason.id }, targetMatches: [], mappedTargetId: null, proposedCode: 'U16-2627' }], targetTeams: [] }
const profile = { profile: { id: profileId, firstName: 'Luca', lastName: 'Rossi' }, category: 'athlete' as const, status: 'active', sourceTeams: [{ id: sourceTeamId, name: 'U16 Test', code: 'U16', jerseyNumber: 8, role: 'athlete' }], targetTeams: [{ id: targetTeamId, name: 'U16 Test 2026', code: 'U16-2627', sourceTeamId }], target: { enrolled: false, status: null, teamIds: [] }, family: [{ relationshipType: 'parent', permissions: ['view_schedule'] }], warnings: [] }
...
describe('SeasonRolloverWizard', () => {
  ...
  it('keeps profiles opt-in and sends the visible assignment summary', async () => {
    render(<SeasonRolloverWizard seasons={[sourceSeason, targetSeason]} onClose={jest.fn()} onCompleted={jest.fn()} />)
    ...
    const assignment = screen.getByRole('checkbox', { name: /U16 Test 2026/ })
