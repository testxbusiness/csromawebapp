...
export const onboardingTours: Tour[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: <>Apri un evento per vedere il dettaglio.</>,
        selector: '#event-detail-title',
        side: 'top',
        showControls: true,
        showSkip: true,
        viewportID: 'event-detail-viewport',
      },
      {
        icon: <>✉️</>,
        title: 'Messaggi',
      ...
      },
      {
        ...
        content: <>Apri un messaggio per vederne i dettagli.</>,
        selector: '#message-detail-title',
        side: 'top',
        showControls: true,
        showSkip: true,
        viewportID: 'message-detail-viewport',
      },
      {
        icon: <>💳</>,
        title: 'Pagamenti',
